...
public class CommonSqlQueries {
	...
	public static final String GET_INSURANCES = "select new com.nrg.models.InsuranceDetails(insurance.vehicle.vechiclenumber, insurance.insurancename, insurance.startdate, insurance.enddate, insurance.reminder) from Insurance insurance where insurance.vehicle.user.userid=:userid and insurance.isactive=1";
}
